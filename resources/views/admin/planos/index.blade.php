                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="filtro_folio" name="folio"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="filtro_solicitante" name="solicitante"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="filtro_apellido_paterno" name="apellido_paterno"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="filtro_apellido_materno"
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="number" step="0.01" class="form-control" id="filtro_hectareas_min"
                                        name="hectareas_min" placeholder="Min">
                                </div>
                                <div class="col-6">
                                    <input type="number" step="0.01" class="form-control" id="filtro_hectareas_max"
                                        name="hectareas_max" placeholder="Max">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="number" class="form-control" id="filtro_m2_min" name="m2_min"
                                        placeholder="Min">
                                </div>
                                <div class="col-6">
                                    <input type="number" class="form-control" id="filtro_m2_max" name="m2_max"
                                        placeholder="Max">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="filtro_numero_plano" name="numero_plano"
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="filtro_tubo" name="tubo"
                                placeholder="Tubo">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="filtro_tela" name="tela"
                                placeholder="Tela">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="filtro_archivo_digital"
                                name="archivo_digital" placeholder="Archivo digital">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="filtro_observaciones">Observaciones</label>
                            <input type="text" class="form-control form-control-sm" id="filtro_observaciones"
                                name="observaciones" placeholder="Buscar en observaciones">
                        </div>
                    </div>
                </div>
            </form>
    ...
    <script>
        ...
        function initPlanosTable() {
            ...
            const columns = [{
                ...
                {
                    "data": "numero_plano_completo",
                    "name": "numero_plano_completo"
                },
                {
                    "data": "folios_display",
                    "name": "folios_display"
                ...
                },
                {
                    ...
                    "name": "solicitante_display"
                },
                {
                    "data": "apellido_paterno_display",
                    "name": "apellido_paterno_display"
                },
                {
                    "data": "apellido_materno_display",
                    "name": "apellido_materno_display"
                },
                {
                    "data": "comuna",
                    "name": "comuna"
                ...
                {
                    "data": "hectareas_display",
                    "name": "hectareas_display"
                },
                {
                    "data": "m2_display",
                    "name": "m2_display"
                ...
                {
                    "data": "observaciones_display",
                    "name": "observaciones_display"
                },
                {
                    "data": "archivo_display",
                    "name": "archivo_display"
                },
                {
                    "data": "tubo_display",
                    "name": "tubo_display"
                ...
                {
                    "data": "archivo_digital_display",
                    "name": "archivo_digital_display"
                },
                {
            ...
            planosTable = $('#planos-table').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        // Simplificar datos de columnas para reducir tamaño del request
                        // Mantener solo data y name, eliminar searchable/orderable/search
                        if (d.columns) {
                            d.columns = d.columns.map(function(col) {
                                return {
                                    data: col.data,
                                    name: col.name
                                };
        ...
        function moveDataTableControls() {
            ...
            setTimeout(function() {
                ...
                if (searchElement.length) {
                    ...
                    // Agregar límite de caracteres al input de búsqueda
                    $('#datatable-search-container input').attr('maxlength', 50);
        ...
        @if (Auth::user()->isRegistro())
            ...
            function agregarFilaFolio(folio) {
                ...
                html += '<td><input type="text" class="form-control form-control-sm folio-num" value="' + (folio.folio ||
                    '') + '"></td>';
                html += '<td><input type="text" class="form-control form-control-sm folio-solicitante" value="' + (folio
                    .solicitante || '') + '"></td>';
                html += '<td><input type="text" class="form-control form-control-sm folio-ap-pat" value="' + (folio
                    .apellido_paterno || '') + '"></td>';
                html += '<td><input type="text" class="form-control form-control-sm folio-ap-mat" value="' + (folio
                    .apellido_materno || '') + '"></td>';
                html += '<td><select class="form-control form-control-sm folio-tipo">';
                html += '<option value="HIJUELA"' + (folio.tipo_inmueble === 'HIJUELA' ? ' selected' : '') +
                    '>HIJUELA</option>';
            ...
            function attachEditPlanoRowListeners($row) {
                ...
                // Actualizar conversión en tiempo real mientras escribe
                $m2Input.off('input').on('input', function() {
                    actualizarConversion();
                });

                // Actualizar conversión al salir del campo
                $m2Input.off('blur').on('blur', function() {
                    actualizarConversion();
                });

                // Re-actualizar conversión si cambia el tipo
                $tipoInput.off('change.tipo').on('change.tipo', function() {
                    actualizarConversion();
                });
            }
            ...
            function actualizarResumenEdit() {
                ...
                $('#folios-tbody tr').each(function() {
                    // Obtener valor de M² y calcular hectáreas automáticamente
                    var m2Valor = $(this).find('.folio-m2').val();
                    if (m2Valor) {
                        var m2 = normalizarNumeroJS(m2Valor);
                        if (m2 !== null && !isNaN(m2) && m2 > 0) {
                            totalM2 += m2;
            ...
            function guardarPlanoCompleto() {
                ...
                var esRural = planoData.tipo_saneamiento === 'SR' || planoData.tipo_saneamiento === 'CR';

                $('#folios-tbody tr').each(function() {
                    numeroFila++;
                    var fila = $(this);

                    // Obtener M² y calcular hectáreas automáticamente
                    var m2 = parseFormattedNumber(fila.find('.folio-m2').val());
                    var hectareas = null;
                ...
                if (erroresFolios.length > 0) {
                    var mensajeError =
                        '<div class="text-left"><p><strong>Los siguientes folios tienen campos vacíos:</strong></p><ul>';
                    erroresFolios.forEach(function(error) {
                        mensajeError += '<li><strong>Fila #' + error.fila + ':</strong> Falta ' + error.campos.join(
                            ', ') + '</li>';
                    });
                    mensajeError +=
                        '</ul><p class="mt-2">Complete los datos o elimine las filas vacías antes de guardar.</p></div>';
                    ...
                    .done(function(response) {
                        ...
                        $.get('{{ url('/planos') }}/' + id + '/detalles-completos')
                            .done(function(planoData) {
                                ...
                                $('#cantidad_folios_reasignar').text(planoData.folios ? planoData.folios.length :
                                0);
                                $('#nuevo_numero').val('Generando...').removeClass('bg-success').addClass(
                                    'bg-light');
            ...
            function initModals() {
                        ...
                        error: function(xhr) {
                            ...
                            if (xhr.status === 422) {
                                ...
                                const message = xhr.responseJSON?.message ||
                                    'No se pudo actualizar el plano';
                                Swal.fire({
                                    icon: 'error',
                ...
                $('#form-reasignar-plano').on('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            const message = xhr.responseJSON?.message ||
                                'No se pudo reasignar el número';
            ...
            function editarFolio(folioId) {
                ...
                $.get("{{ url('/planos/folios') }}/" + folioId + "/edit")
                    .done(function(response) {
                        ...
                        // Actualizar label dinámico según tipo
                        const tipoInmueble = response.folio.tipo_inmueble;
                        const labelTexto = tipoInmueble === 'HIJUELA' ? 'Número de Hijuela' : 'Número de Sitio';
                        $('#edit_folio_numero_inmueble_label').text(labelTexto);

                        // Actualizar título de tabla de inmuebles
                        const tituloInmuebles = tipoInmueble === 'HIJUELA' ? 'Hijuelas de este Folio' : 'Sitios de este Folio';
                        $('#edit_folio_inmuebles_title').text(tituloInmuebles);

                        // Verificar si tiene inmuebles desglosados
                        const inmuebles = response.folio.inmuebles || [];
        ...
        <div class="card mb-3">
            ...
            $('#form-agregar-folio').on('submit', function(e) {
                ...
                if ($('.numero-inmueble').length === 0) {
                    Swal.fire('Atención', 'Debes seleccionar cuántas ' + tipoInmuebleGlobal.toLowerCase() +
                        's tiene este folio', 'warning');
                    return;
                }
...
@push('styles')
    <style>
        ...
        /* Comuna */
        #planos-table td:nth-child(8) {
            max-width: 80px;
        }

        /* Hectáreas */
        #planos-table td:nth-child(9) {
            max-width: 80px;
        }

        /* M² */
        #planos-table td:nth-child(10) {
            max-width: 60px;
        }

        /* Mes */
        #planos-table td:nth-child(11) {
            max-width: 60px;
        }

        /* Año */
        #planos-table td:nth-child(12) {
            max-width: 120px;
        }

        /* Responsable */
        #planos-table td:nth-child(13) {
            max-width: 120px;
        }

        /* Proyecto */
        #planos-table td:nth-child(14) {
            max-width: 50px;
        }
        ...
        .datatable-container {
            ...
            /* Altura dinámica: 100% viewport - espacio para header/navbar/controles */
            overflow: auto;
        ...
        .datatable-container .table {
            margin-bottom: 0;
            min-width: 1800px;
            /* Ancho mínimo para garantizar scroll horizontal */
            white-space: nowrap;
        ...
        .datatable-container::-webkit-scrollbar {
            width: 12px;
            /* Barra vertical un poco más ancha */
            height: 16px;
            /* Barra horizontal más amplia para mejor usabilidad */
        }
        ...
        .datatable-controls-bar-compact {
            ...
            padding: 8px 12px;
            /* Padding reducido drásticamente */
            position: sticky;
            top: 0;
            z-index: 20;
            box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05);
            min-height: 40px;
            /* Altura mínima muy reducida */
        }
